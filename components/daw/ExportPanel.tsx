      ...
      {open && (
        <div className="flex flex-wrap items-center gap-3 border-t border-navy-800/60 px-4 py-3">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-lg border border-[#ffcc18]/40 bg-[#ffcc18]/10 px-3 py-1.5 text-xs font-medium text-gold transition-colors hover:bg-[#ffcc18]/20"
          >
